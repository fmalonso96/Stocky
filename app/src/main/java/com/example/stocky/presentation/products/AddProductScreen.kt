...
@Composable
fun AddProductScreen(viewModel: SharedViewModel, onAddProduct: () -> Unit) {

    val category = remember { mutableStateOf(EMPTY_STRING) }
    val name = remember { mutableStateOf(EMPTY_STRING) }
    val price = remember { mutableStateOf(EMPTY_STRING) }
